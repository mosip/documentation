...
This documentation currently covers the eSignet 1.x line, with eSignet-Go (2.x) content being added progressively. See [Releases](roadmap-and-releases/versions/) for the full version history.
