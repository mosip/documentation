...
\
\
![:point\_right:](https://a.slack-edge.com/production-standard-emoji-assets/16.0/apple-medium/1f449@2x.png) Explore More<br>
...
* Remove "Community Calendars"

\
\
Remove these pages from docs, as they exist in GitHub, and have been linked from above to GitHub.<br>
