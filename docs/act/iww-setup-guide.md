...
This guide aims to help a developer setup up Inji Web for development.

## How is this guide organized?

1. Method-1: Docker Setup
2. Method-2: Manual (Non-Docker) Setup



## Prerequisites

* Install node 18 using [nvm](https://github.com/nvm-sh/nvm), a minimum Node 18is required.  
...
# Method 1: Run Inji Web locally using Docker Compose:
...
2. **Prepare the environment:**
   ...
   * **Update the configuration files:**
     ...
     * `mimoto-trusted-verifiers.json` (Add Verifier's clientId and redirect URI for online sharing)
     * Update **Esignet host references** in the `mimoto-default.properties`, `mimoto-issuers-config.json` files. <!-- We need to describe why and how -->
     * Set the `oidc_p12_password` environment variable value as per the documentation. <!-- We need to describe/link to docs detailing why and how -->
...
3. **[Optional] Configure Google OAuth Client Credentials** <!-- Optional should not be the part of this flow, find another place for this -->
...
# Method 2: Inji Web Manual Setup (Non-Docker Compose Setup)
...
1. Clone the repositories locally to bring up your own setup.

`https://github.com/mosip/inji-web.git`.


Note: Refer to the [**release notes**](https://github.com/mosip/inji-web/releases) to know about the released versions.

2. **Navigate to the `inji-web` folder and install dependencies:**
...
3. **Start the Inji Web application:**
