...
MOSIP test automation suite requires large set of synthetic biometric data such as IRIS for.
This project attempts to generate larger set of IRIS images from the given set of sample IRIS images. The solution is built using Guided-Diffusion with pre-trained models MOSIP USSD Proxy feature enhancements. 
