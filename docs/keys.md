...
|---|---|
|DKL0|Device key L0|RSA 2048|Private key, self signed certificate|Host machine|MDS|Auto generated by MDS|
|DKL1|Device key L1|RSA 2048|Private key, self signed certificate|FTM|FTM Provider|Fused during manufacturing|
|FK1|FTM key|
