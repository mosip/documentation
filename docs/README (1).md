...
| ------------------------------------------------------------------- | -------- |
| Issuer Metadata                                                     | Yes      |
| Support for access token validation                                 | Yes      |
| Credential Issuance                                                 | Yes      |
| Credential Binding with did:.. keys                                 | Yes      |
| Credential Binding with jwt proof                                   | Yes      |
| Support for JSON\_LD VC Format                                      | Yes      |
| Support for IETF SD\_JWT VC Format with support only for vc+sd\_jwt | Yes      |
| Revocation support for JSON\_LD                                     | Yes      |
| Support for mDoc/mDL VC Format                                      | No       |
| Credential Offer with Pre Authorisation Code Flow                   | No       |
| Credential Offer with Authorisation Code Flow                       | No       |
| Credential Binding with cwt proof                                   | No       |
...
* **Overview: Choosing the Right Plugin** – Learn the differences between the two plugin types and how to decide which suits your issuer requirements.
...
1. **Local Development Setup**
   * Intended for experimentation and user experience. Local Setup can be carried out in two ways:
     * **Local Setup with Docker Compose**
       ...
       * Refer to this guide to try this mode of setup.
...
Refer to SQL scripts and go through its README.

### Upgrades

#### Upgrade from 0.11.0 to 0.12.0

Please refer to step-by-step migration guide for upgrade from 0.11.0 to 0.12.0.
