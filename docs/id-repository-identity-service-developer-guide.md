...
For instance,
  ...
  * Set value of `mosip.kernel.xsdstorage-uri` in application-default.properties to sandbox-local folder location.(For example: mosip.kernel.xsdstorage-uri=file:///home/user/Desktop/tspl/mosip-config/sandbox-local/` i.e.sandbox-local folder location.
