...
{% hint style="info" %} [ABIS](ABIS.md) is used for 1:N deduplication while Biometric SDK is primarily used for 1:1 authentication and quality check. MOSIP does not recommend using an ABIS system for 1:1 authentication.{% endhint %}
