...
{% hint style="info" %}
The P12 file for the above encrypted CBEFF file is available [here: cbeff.p12](https://github.com/mosip/documentation/blob/1.1.5/docs/_files/abis/cbeff.p12).
