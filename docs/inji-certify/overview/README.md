...
Old content - If needed atall, Get the good part out of this and put it in the right place in the new documentation structure above. Remove this comment once done.
...
To know more about features available in certify please refer to [this documentation](features.md).
