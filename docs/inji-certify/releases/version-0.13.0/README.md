...
The [Revocation feature](https://docs.inji.io/inji-certify/overview/features#id-7.-revocation-mechanism-json-ld-only) is now fully functional, issuers can revoke VCs, and the ledger can be configured for indexing to support efficient search for revocation lookup.
