...
| data.timestamp            | <ul><li>Time as per the biometric device.</li><li>Sharing the capture <code>timestamp</code> in response is mandatory. </li><li>Note: The biometric device is expected to sync its time from the management server at regular intervals so accurate time could be maintained on the device.</li></ul>                                                                                |
...
| data.transactionId        | Unique transaction id sent in request                                                                                                                                                                                                                                                                                       |
| data.timestamp            | <ul><li>Time as per the biometric device.</li><li>Sharing the Rcapture <code>timestamp</code> in response is mandatory.</li><li>Note: The biometric device is expected to sync its time from the management server at regular intervals so accurate time could be maintained on the device.</li></ul>                       |
