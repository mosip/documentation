...
| Parameters      | Description                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           |
| --------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| deviceStatus    | <ul><li>Allowed values are "Ready", "Busy", "Not Ready" or "Not Registered".</li><li>Error codes should be sent for device in "Busy", "Not Ready" and "Not Registered" from the below <a href="(MOSIP-Device-Service-Specification.md#error-codes)">error code section</a>.</li><li><p></p><ul><li></li></ul></li></ul>                                                                                                                                                                                                                                               |
...
| deviceInfo.deviceStatus   | <ul><li>This is the status of the device.</li><li>Allowed values are "Ready", "Busy", "Not Ready" or "Not Registered".</li><li>Error codes should be sent for device in "Busy", "Not Ready" and "Not Registered" from the below <a href="(MOSIP-Device-Service-Specification.md#error-codes)">error code section</a>.</li></ul>                                                                                                                                                                                                                                       |
