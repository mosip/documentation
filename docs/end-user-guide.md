...
* The chosen language will be reflected within the app interface. Subsequently, a four-page tutorial for the Inji Wallet will be presented, followed by the option to secure the app.
...
* Two or more devices with Inji Wallet installed are required for sharing credentials.
