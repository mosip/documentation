...
To read more about PixelPass library refer [**here**](../../technical-overview/integration-guide/building-verifiable-credentials-wallet-with-inji-libraries/pixelpass.md).
