...
As a part of manageability, a fully supported [Admin](../../modules/administration/admin-portal-user-guide.md) and [Partner Management Portal](../../modules/partner-management-services/pms-existing/partner-management-portal.md) with the ability to self-register partners is included. To help with the operational needs, a fully-working reference [Reporting](../../modules/reporting.md) module is included that can be used by the adopters to track and monitor the analytics around MOSIP.
