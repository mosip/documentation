...
* [Technical Overview](inji-web/technical-overview/README.md)
  ...
  * [Tools and Libraries](inji-web/technical-overview/tools-and-libraries.md)
  ...
  * [Backend Services](inji-web/technical-overview/backend-services/README.md)
    * [Mimoto (APIs used)](inji-web/technical-overview/backend-services/mimoto-apis-used.md)
    * [eSignet (APIs used)](inji-web/technical-overview/backend-services/esignet-apis-used.md)
* [Try it out](inji-web/try-it-out.md)
* [Releases](inji-web/inji-web/README.md)
  * [Version 0.8.0](inji-web/inji-web/version-0.8.0.md)
* [Build & Deploy (local setup, server installation, configurations, troubleshoot, …)](inji-web/build-and-deploy-local-setup-server-installation-configurations-troubleshoot-....md)
* [Customizations](inji-web/customizations.md)
* [Components](inji-web/components/README.md)
  * [Overview](inji-web/components/overview.md)
  * [Integration guides](inji-web/components/integration-guides.md)
* [Specifications](inji-web/specifications.md)
* [Supported Integrations (MOSIP)](inji-web/supported-integrations-mosip.md)
