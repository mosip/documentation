...
* Build & Deploy
	* [Sandbox Installer](Sandbox-Installer.md)
		...
		* [Build[Local docker registry](mosip-configuration/local-docker-registry.md)
		...
		* [Registration client](mosip-configuration/tpm-for-reg-client.md) & Deploy](Build-and-Deploy.md)
