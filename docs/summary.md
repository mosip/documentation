...
* [🈴 Upgrade Runbook](upgrade-runbook.md)
    * [Upgrade of Deployment Architecture from V2 to V3](upgrade-deployment-architecture.md)
    * [Upgrade of Platform from version 1.1.5.5-P1 to 1.2.0.1](upgrade-platform.md)
      ...
      * [Handling unequal certificates in IDA and Key-Manager Databases](upgrade-handling-unequal-certificates.md)
      * [Update identity-mapping json file in configuration](upgrade-identity-json-file.md)
      * [New Datashare Properties](upgrade-new-datashare-properties.md)
      * [Registration Processor: Processing non-recoverable packets from the start](upgrade-non-recoverable-packets.md)
      * [Partners' Certificate Expired](upgrade-partner-certificate-expired.md)
      * [Partner organization name mismatch error](upgrade-partner-organization-name.md)
      * [Pre-Registration UI Upgrade](upgrade-prereg-ui-specifications.md)
      * [Registration Client Upgrade](upgrade-registration-client.md)
      * [Registration Processor: How to Reprocess from the beginning](upgrade-regproc-reprocessing.md)
    * [Optional steps](upgrade-optional-steps.md)
