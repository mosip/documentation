...
* [🈴 Upgrade Runbook](upgrade-runbook.md)
    ...
    * [Additional Information](upgrade-additional-info.md)
      * [Handling Duplicate Entries](upgrade-DB-script-error.md)
      * [Adapting Changes in Administration Roles](upgrade-admin-services-roles-guide.md)
      * [Identifying Applicant Type](upgrade-applicant-typeMVEL-scriptmigration.md)
      * [Changes in Camel Route](upgrade-camel-route-changes.md)
      ...
      * [Handling Partner Organization Name Mismatch Issue](upgrade-partner-organization-name.md)
      ...
      * [Guide to Reprocess Packets Manually](upgrade-regproc-reprocessing.md)
