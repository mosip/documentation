...
4. **Plugins**: Integration points with external systems are designed to be pluggable, allowing easy integration. The pluggable integration points are as follows:
   * [**Profile Registry Plugin**](https://docs.esignet.io/test/integration-guide-signup-portal/profile-registry-plugin)- To create and update user identity data
   * [**Identity Verifier Plugin**](https://docs.esignet.io/test/integration-guide-signup-portal/identity-verifier-plugin) - Plugin to verify the user identity data, basically the backend for the eKYC verification process.
   * [**Audit Plugin**](https://docs.esignet.io/test/integration/audit) - For auditing all events
