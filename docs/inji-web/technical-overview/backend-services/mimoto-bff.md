...
{% swagger src="../../../.gitbook/assets/mimoto_credTypes.yaml" path="/issuers/{issuer-id}/credentialTypes" method="get" %}
[mimoto_credTypes.yaml](../../../.gitbook/assets/mimoto_credTypes.yaml)
{% endswagger %}
