...
![](.gitbook/assets/sandbox_architecture.png)
...
* [DNS](Sandbox-Installer.md#domain-name-system-dns)
* [Local docker registry](Sandbox-Installer.md#local-docker-registry)
* [Private dockers](Sandbox-Installer.md#private-dockers)
* [Sandbox access](Sandbox-Installer.md#sandbox-access)
* [Secrets](Sandbox-Installer.md#secrets)
* [Config server](Sandbox-Installer.md#config-server)
* [Pre-Reg captcha](Sandbox-Installer.md#pre-reg-captcha)
* [OTP](Sandbox-Installer.md#otp-setting)
* [Master data](Sandbox-Installer.md#master-data)
* [Pod replication](Sandbox-Installer.md#pod-replication)
* [Taints](Sandbox-Installer.md#taints)
* [TPM](Sandbox-Installer.md#tpm-for-reg-client)
* [Pre-Registration Schema](Sandbox-Installer.md#configure-pre-reg-for-id-schema)
* [Registration client](Sandbox-Installer.md#registration-client-with-mock-mds-and-mock-sdk)
...
* On the console machine, the tokens for the above dashboards are accessible at\_`/home/mosipuser/mosip-infra/deployment/sandbox-v2/tmp`\_. For each dashboard, two tokens are created - admin and view-only. View-only privileges are restricted.
