...
1. [**Identity Assurance Implementation**](../../../overview/features/#identity-assurance-flow-ekyc-verification)
...
2. [**Signup and Login with OTP for Verified Claims**](../../../test/end-user-guide/health-portal/signup-and-login-with-otp-for-verified-claims.md)
   * Added video eKYC via WebSocket in the signup portal, enabling secure, real-time video verification during registration.
3. [**Well-Informed Claim Details**](../../../overview/features/#claim-level-status)
