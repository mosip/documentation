...
![](.gitbook/assets/ctk-resources-folder-new.png)
...
![](.gitbook/assets/ctk-testcases-repo.png)
...
2. Provide the required parameters:
   ...
   * Enter the template name as **terms\_and\_conditions\_template**.
3. The template file extension should be`.vm`(Velocity Template Language).
4. Then , execute it

![](.gitbook/assets/ctk-upload-template.png)
