...
The [SignUp portal](../../features/signup-portal.md) provides a user-friendly registration interface that allows users to securely create and manage accounts.
