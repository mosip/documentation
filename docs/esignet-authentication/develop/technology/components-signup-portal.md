...
4. **Plugins**: Integration points with external systems are designed to be pluggable, allowing easy integration. The pluggable integration points are as follows:
   * [**Profile Registry Plugin**](../../../esignet-signup/integration-guide-signup-portal/profile-registry-plugin.md)- To create and update user identity data
   * [**Identity Verifier Plugin**](../../../esignet-signup/integration-guide-signup-portal/identity-verifier-plugin.md) - Plugin to verify the user identity data, basically the backend for the eKYC verification process.
