...
Added: 26 june 2025
Reviewed: Done - 26-06-2025 (Update Links) 
...
* **Multiple Login ID Options** <!-- Link to the login configuration page under configure eSignet -->
  Enable users to choose from different login identifiers such as email, phone number, or username thereby improving accessibility across user segments.
* **Theme and Layout Customization**
  Tailor the look and feel to match your portal’s branding, including colors, logos, fonts, and button styles.
