...
* [**Purpose Display Configuration**](Update-link) <Link to the Purpose based configuration page>
Clearly indicate the intent of the action—e.g., Login, Verify Identity, or Link Account—to guide user interaction.

* [**Multiple Login ID Options**](Update-link) <Link to the login configuration page under configure eSignet>
...
[**How to configure KBI form in eSignet UI?**](features.md#how-to-configure-kbi-form-in-esignet-ui)
...
* **Multiple Login ID Options** Enable users to choose from different login identifiers such as email, phone number, or username thereby improving accessibility across user segments.
* **Theme and Layout Customization** Tailor the look and feel to match your portal’s branding, including colors, logos, fonts, and button styles.
